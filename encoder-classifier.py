...
class VGGishEncoder(nn.Module):
    def __init__(self, num_classes, params):
        ...
        self.classifier = nn.Linear(self.params.embedding_dim, num_classes)  # 5 classes for breathing types
...
class WhisperEncoder(nn.Module):
    def __init__(self, model_name, num_classes, params):
        super().__init__()
        self.params = params if params else TrainingParams()
        ...
        self.classifier = nn.Linear(self.params.embedding_dim, num_classes) 
...
class ASTEncoder(nn.Module):
    ...
    def forward(self, x, labels=None, mode='train'):
        ...
        return self.classifier(projected_embeddings)
